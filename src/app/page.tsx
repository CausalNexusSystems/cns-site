...
function CausalBackground({ intensity = 0.65, focus = "top" }: { intensity?: number; focus?: SectionKey }) {
...
function PredictiveNodes({ active, nextKey, onHover }: { active: SectionKey; nextKey: SectionKey; onHover: (k: SectionKey | null) => void }) {
            ...
            return (
              ...
              >
                <span className="h-2.5 w-2.5 rounded-full" style={{
                  background: isActive ? "rgba(56,189,248,0.95)" : isNext ? "rgba(56,189,248,0.55)" : "rgba(255,255,255,0.22)",
          ...
          <div className="relative p-6">
            ...
            {module.heroSrc && (
              <div className="relative mt-6 overflow-hidden rounded-2xl ring-1 ring-white/10">
                <Image src={safeSrc(module.heroSrc)} alt={`${module.name} visual`} width={1600} height={900}
...
export default function Home() {
  ...
  const modules = useMemo<ModuleInfo[]>(() => [
    {
      key: "ASTRA", name: "ASTRA", subtitle: "Aerospace causal autonomy",
      description: "Public causal observability for launch, mission, and telemetry coherence designed for aerospace systems where anticipation matters.",
      problems: ["Launch & mission coherence under uncertainty", "Telemetry gaps with structured reconstruction narratives", "Causal surfaces before failure becomes visible"],
      logoSrc: "/brand/astra_logo.png", heroSrc: "/brand/astra_hero.png",
      publicRuns: [{ label: "ASTRA runs (public)", url: "https://www.linkedin.com/feed/update/urn:li:activity:7403822252661813248/" }],
    },
    {
      key: "SQS", name: "SQS", subtitle: "Shield Quantum Secure",
      description: "Causal security posture: observe intent surfaces before visible breach. Built for critical environments and non-negotiable reliability.",
      ...
      logoSrc: "/brand/sqs_logo.png", heroSrc: "/brand/sqs_hero.png",
      publicRuns: [{ label: "SQS posts (public)", url: "https://www.linkedin.com/feed/update/urn:li:activity:7393030639832387584/" }],
    },
    {
      key: "CAE", name: "CAE", subtitle: "Capital Adaptive Engine",
      description: "Institutional regime observability and capital flow surfaces. Public layer explains signals without exposing proprietary internals.",
      ...
      logoSrc: "/brand/cae_logo.png", heroSrc: "/brand/cae_hero.png",
      publicRuns: [{ label: "CAE demos / runs (public)", url: "https://www.linkedin.com/feed/update/urn:li:activity:7416935443486629888/" }],
    },
    {
      key: "NEXA", name: "NEXA", subtitle: "Neural Exchange Analyzer",
      description: "Coherence monitoring and interpretability layer for public causal narratives without revealing private kernel mechanics.",
      problems: ["Coherence drift detection", "Explainable public outputs", "Signal stability narratives"],
      logoSrc: "/brand/nexa_logo.png", heroSrc: "/brand/nexa_hero.png",
      publicRuns: [{ label: "NEXA notes (public)", url: "https://www.linkedin.com/feed/update/urn:li:activity:7400582525661908992/" }],
    },
    {
      key: "NARP", name: "NARP", subtitle: "Nexus Asset Restoration Protocol",
      description: "Sealed outputs and integrity workflow storytelling: SHA-256 + Merkle root verification as public proof of existence and process.",
      problems: ["Integrity proofs", "Tamper-evident sealing workflows", "Audit-ready public artifacts"],
      logoSrc: "/brand/narp_logo.png", heroSrc: "/brand/narp_hero.png",
      publicRuns: [{ label: "NARP proofs (public)", url: "https://www.linkedin.com/feed/update/urn:li:activity:7407801748838498304/" }],
    },
    {
      key: "IGNIS", name: "IGNIS", subtitle: "Stability & energy narratives",
      description: "Public layer stays conceptual + demo-based. Focused on stability narratives and causal surfaces. No private modeling exposed.",
      problems: ["Stability narratives", "Early anomaly surfaces", "Explainable public outputs"],
      logoSrc: "/brand/ignis_logo.png", heroSrc: "/brand/ignis_hero.png",
      ...
      <section id="modules" className="relative z-10 mx-auto w-full max-w-6xl px-6 py-14">
        <div className="flex items-end justify-between gap-6">
          <div>
            ...
            <p className="mt-2 max-w-2xl text-white/70">Each module is a public window into CNS. Click a module for description + problems solved + direct LinkedIn runs.</p>
          </div>
        </div>

        <div className="mt-8 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
          {modules.map((m) => (
            <button key={m.key} onClick={() => setOpenModule(m)} onMouseEnter={() => setHoverFocus("modules")} onMouseLeave={() => setHoverFocus(null)}
              ...
              <div className="mt-4 overflow-hidden rounded-2xl ring-1 ring-white/10">
                <Image src={safeSrc(m.heroSrc, "/brand/cns_banner.png")} alt={`${m.name} hero`} width={1400} height={900} className="h-[180px] w-full object-cover sm:h-[200px]" />
              </div>
              ...
              <div className="mt-5 flex flex-wrap items-center gap-3">
                ...
                <a href={m.publicRuns?.[0]?.url || "#"} target="_blank" rel="noreferrer" onClick={(e) => e.stopPropagation()}
                   className="text-xs text-white/80 underline decoration-white/25 hover:decoration-white/60">LinkedIn →</a>
              </div>
            </button>
          ))}
        </div>
